package com.kigo.language.scala.basic.akka

/**
  * Created by kigo on 9/24/17.
  */
...
class LogSearchActor extends Actor {
  ...
  def receive = {
    case Search(worktimes, timeout) =>
      ...
      // PipeTo is a akka pattern to return results of a future to the sender
